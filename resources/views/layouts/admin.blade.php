            ...
            <nav class="navbar navbar-expand-lg navbar-light">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav flex-column">
                        ...
                        <li class="nav-item ">
                            <a class="nav-link active" href="#" data-toggle="collapse" aria-expanded="false" data-target="#editpagemenu" aria-controls="submenu-1"><i class="fa fa-fw fa-user-circle"></i>Edit content <span class="badge badge-success">6</span></a>
